...
func validateSubscriptionRequest(c *gin.Context, req SubscriptionRequest) (error, models.SubscriptionPlan) {
...
func createSubscription(req SubscriptionRequest, plan models.SubscriptionPlan) (error, models.Subscription) {
...
func createInvoice(req SubscriptionRequest, plan models.SubscriptionPlan) (error, models.Invoice) {
